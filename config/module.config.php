...
$config = array(
    ...
    'view_helpers'    => array(
        'invokables' => array(
            'calendarLink' => 'Calendar\View\Helper\CalendarLink',
    ...
    'service_manager' => array(
        'factories'  => array(
            'calendar-assertion' => 'Calendar\Acl\Assertion\Calendar',
        ),
        'invokables' => array(
            'calendar_generic_service'      => 'Calendar\Service\CalendarService',
            'calendar_form_service'         => 'Calendar\Service\FormService',
            'calendar_calendar_form_filter' => 'Calendar\Form\FilterCreateCalendar',
